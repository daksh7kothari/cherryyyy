...
export function EventCard({
  ...
  const tiltClass = tilt === "left" ? "lg:-rotate-2" : "lg:rotate-2";

  return (
    <article
      className={`relative border-[3px] border-[#fc0162] bg-white p-3 shadow-[8px_8px_0_0_rgba(252,1,98,0.18)] ${tiltClass}`}
    >
